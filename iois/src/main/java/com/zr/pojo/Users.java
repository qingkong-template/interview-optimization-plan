...
@ApiModel(value="候选人对象", description="这是候选人对象")
public class Users {
    /**
     * 用户ID
     */
     ...
     * 用户名
     */
    @ApiModelProperty(value="候选人", name="userName", example="你是谁", required=false)
    @Excel(name = "候选人", orderBy = "1")
     ...
     * 性别：1、男。2、女。
     */
    @Excel(name = "性别", orderBy = "2")
    private Integer sex;

    /**
     * 电话
     */
    @Excel(name = "电话", orderBy = "3")
